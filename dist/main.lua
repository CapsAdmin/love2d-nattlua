...
IMPORTS['src/event.nlua'] = assert(loadstring([=======[ return function() local love_events = {
	"displayrotated",
	"draw",
	"errorhandler",
	"load",
...
return event end ]=======], '@src/event.nlua'))()
...
IMPORTS['src/game/world.nlua'] = assert(loadstring([=======[ return function() love.physics.setMeter(64)
local world = love.physics.newWorld(0, 0, true)
return world end ]=======], '@src/game/world.nlua'))()
IMPORTS['src/game/vec2.nlua'] = assert(loadstring([=======[ return function() local Vec2 = {}
Vec2.__index = Vec2
...
return Poop end ]=======], '@src/game/poop.nlua'))()
...
return Dog end ]=======], '@src/game/dog.nlua'))()
...
return Trash end ]=======], '@src/game/trash.nlua'))()
